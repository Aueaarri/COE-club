...
@section('content')
    ...
    <div class="content">
        ...
        <div class="text">
            <h2 class="blue"><i class="fa-solid fa-robot"></i>&nbsp;&nbsp;One Room at a Time, Please</h2>
            <p> Each booking is for one room at a time, so grab it for yourself or share with your fav people.</p>
            <br>
            <h2 class="yellow"><i class="fa-solid fa-clock"></i>&nbsp;&nbsp;&nbsp;Limit of 4 Hours per Booking</h2>
            <p> To make sure everyone gets a turn, each booking is limited to a max of 4 hours.</p>
            <br>
            <h2 class="blue"><i class="fa-regular fa-calendar"></i>&nbsp;&nbsp;&nbsp;Book Anytime, Rooms Open 24/7!</h2>
            <p> No need to check the clock—our rooms are open 24/7!</p>
            <br>
            <h2 class="yellow"><i class="fa-solid fa-circle-check"></i>&nbsp;&nbsp;&nbsp;Confirm Within 15 Minutes of Arrival</h2>
